...
class FreezerSchedulerDetect(monasca_setup.detection.Plugin):
    """Detect freezer-scheduler and setup configuration to monitor it.
    """
    ...
    def build_config(self):
        ...
        """
        log.info("\tEnabling the freezer-scheduler plugin")
